  ...
  namespace ushell {
    ...
    namespace services {
      ...
      class Container {
         ...
         * An enumeration for the application work protect mode state.
         */
        DirtyState: sap.ushell.services.Container.DirtyState;
      ...
      class SmartNavigation {
         ...
         * not.  Note that an instance of this service should be obtained with `sap.ushell.services.Container#getServiceAsync("SmartNavigation").then(function
         * (SmartNavigation) {});`
         * See:
         * 	sap.ushell.services.Container#getServiceAsync
         */
